	...
	<body>
		...
		<div class="container">
			<div class="card">
				...
				<div class="card-body">
					<p>
						<?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?> is a 100% transparent, 100% open source Roblox private server. We want to recreate the fun of playing Roblox from all client versions 2007 through 2017
						without imposing restrictions on developers, users, or anybody who wants to play <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>.
						<br><br>
						...
						<ul>
							...
							<li>Being open source so people can contribute, fix, solve issues, and develop for <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?></li>
							<li>Maintaining 100% transparency in what staff members do (see staff audits <a href="/audits/">here</a>)</li>
						</ul>
						
						<?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?> is created with the sense of transparency at it's heart, after many other Roblox private servers did not uphold transparency fully.
					</p>
				</div>  
			</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<p>
						Our goal is to be as transparent and open source as possible and not creating any doubt in newcomers or users of <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>.
						<br><br>
			...
			<div class="card">
				...
				<div class="card-body">
					<p>
						<?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?> is created by a team of young, aspiring developers of whose contributions you can see on the <a href="<?php echo(ENVIRONMENT["REPOSITORY"]["URL"]); ?>/graphs/contributors">GitHub contributors page</a>.
						<br><br>
