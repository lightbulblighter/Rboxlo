	...
	<body>
		...
		<div class="container">
			...
			<div class="card">
				...
				<div class="card-body">
					<p>You are already verified on <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>!</p>
				</div>  
			</div>
			...
			<div class="card">
				...
				<div class="card-body">
					<p>In order to access some features on <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>, you need to verify your E-Mail address first. Some of those features include:</p>
					<ul>
					...
					<p>
						Essentially, you literally cannot do anything on <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?> without verifying your E-Mail address.
						<br><br>
						Fortunately for you, we at <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?> have made the process of verifying your E-Mail address very simple. Just click that big purple button below, solve the captcha, and it'll send you a verification message to the E-Mail address you signed up with. Simply click on the link sent in that E-Mail, and you're done!
						<br><br>
						If you can't find the E-Mail in your main inbox, search for <?php echo(ENVIRONMENT["EMAIL"]["ADDRESS"]); ?> in all inboxes or check your spam folder for incoming messages from <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>. If neither of those work, just re-send the E-Mail by clicking the purple button again.
					</p>
			...
			<div class="card">
				...
				<div class="card-body">
					<p>
						Are you sure you want to verify your account, <?php echo($_SESSION["user"]["username"]) ?>, with the E-Mail <code><?php echo($_SESSION["user"]["email"]); ?></code> on <?php echo(ENVIRONMENT["PROJECT"]["NAME"]); ?>?
					</p>
