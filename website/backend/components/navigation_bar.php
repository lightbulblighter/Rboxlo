...
<div class="news text-center pt-2 pb-2 news-red">
    Hey <b><?php echo($_SESSION["user"]["username"]); ?></b>, in order to access some features on <?php echo(BASE_NAME); ?>, you need to <a href="/my/verify" class="font-weight-bold" style="color: #41bbf4">verify your E-Mail address!</a>
</div>
