	...
	<body>
		...
		<div class="container">
			<div class="card">
				...
				<div class="card-body">
					<p>
                        At <?= ENVIRONMENT["PROJECT"]["NAME"] ?>, we expect you to follow a terms of service and a basic set of rules in order to use this website. The terms are as follows:

                        <ul>
                            <li><b>You must be 13 years old or older</b> to use <?= ENVIRONMENT["PROJECT"]["NAME"] ?> or when creating an account.</li>
