<footer class="page-footer center-on-small-only stylish-color-dark">
	<div class="container pt-3 pb-4">
		...
		<ul class="nb-ul list-group list-group-horizontal nav">
			...
			<li class="flex-fill text-center"><a href="<?= ENVIRONMENT["REPOSITORY"]["URL"] ?>" class="text-white font-weight-light h5 text-fluid nav-item px-3 py-3">GitHub</a></li>
			<li class="flex-fill text-center"><a href="<?= ENVIRONMENT["PROJECT"]["DISCORD"]?>" class="text-white font-weight-light h5 text-fluid nav-item px-3 py-3">Discord</a></li>
		</ul>
	</div>
	<div class="footer-copyright">
		<div class="container-fluid text-center pt-2 pb-2">
			<span>
				<?= ENVIRONMENT["PROJECT"]["NAME"] ?> is made with <i class="material-icons" style="font-size: 1rem" data-toggle="tooltip" title="" data-original-title="lots of love <3">favorite</i> by <a href="<?= ENVIRONMENT["REPOSITORY"]["URL"] ?>/graphs/contributors">many different contributors</a>.
			</span>
		</div>
	</div>
</footer>
