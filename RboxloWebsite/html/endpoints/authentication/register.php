    ...
    if (!$error)
    {
        ...
        if (!$error)
        {
            ...
            if (!$error)
            {
                ...
                {
                    $message = "In order to create an account on ". BASE_NAME .", you must enter a username.";
                    $error = true;
                }
                ...
                {
                    $message = "In order to create an account on ". BASE_NAME .", you must enter a password.";
                    $error = true;
                }
